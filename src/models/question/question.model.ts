...
questionSchema.index({ subject: 1, topic: 1, academicLevel: 1 });
...
questionSchema.statics.getQuestionsBySubject = async function(subject: string) {
...
questionSchema.statics.searchQuestions = async function(filters: IQuestionSearchFilters) {
  const query: any = {};
